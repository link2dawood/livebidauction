  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="2" cellspacing="0">
      <tbody><tr class="dataTableHeadingRow">
        ...
        <td class="dataTableHeadingContent-invoice" align="right">{BUYER_FEE}</td>
	...
	<!-- IF B_IS_AUCTION -->
		<tr class="dataTableRow">
			...
			<td class="dataTableContent" valign="top" align="right"><b>{UNIT_BUYEER_FEE}</b></td>
     ...
     <tr>
        <td colspan="5" align="right"><br> <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <td class="smallText" align="right">{TAX_TITLE}</td>
			<td class="smallText" align="right">{TAX_FEE}</td>
