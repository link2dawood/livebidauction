		<div class="visible-xs visible-sm">
			<div class="dropdown grid-margin-btm-md">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
					...
					<li><a href="{SITEURL}admin/listfloorauctions.php">Floor Bidder</a></li>
                    <li class="hide"><a href="{SITEURL}admin/listreportedauctions.php">{L_view_reported_auctions}</a></li>
			...
			<div>
				<ul class="list-group hidden-xs">
					...
					<li class="list-group-item"><a href="{SITEURL}admin/listfloorauctions.php">Floor Bidder</a></li>
					<li class="list-group-item hide"><a href="{SITEURL}admin/listreportedauctions.php">{L_view_reported_auctions}</a></li>
