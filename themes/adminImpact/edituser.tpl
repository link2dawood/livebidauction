				...
				<form name="errorlog" action="" method="post">
					...
					<tr>
						...
						<td width="33%" valign="top">
							<p><input type="radio" <!-- IF ISFLOOR eq 1 --> checked <!-- ENDIF --> name="user_floor" value="1" /> Yes</p>
							<p><input type="radio" <!-- IF ISFLOOR eq 0 --> checked <!-- ENDIF --> name="user_floor" value="0" /> No</p>
						</td>
					</tr>
					<tr class="bg">
						<td>&nbsp;</td>
