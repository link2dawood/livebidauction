...
if (isset($_POST['action']) && $_POST['action'] == 'update')
{
	if ($_POST['name'] && $_POST['email'])
	{
		...
		else
		{
			...
			$query = "INSERT INTO " . $DBPrefix . "users (name, nick, email, address, city, prov, country, zip, phone,is_floor, birthdate, groups, balance, password)
					VALUES (:name, :nick, :email, :address, :city, :prov, :country, :zip, :phone, :is_floor, :birthdate, :groups, :balance, :password)";
			$params = array();
