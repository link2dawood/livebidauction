<table border="0" width="100%">
	...
	<tr>
		...
		<table border="0" width="100%">
			...
			<tr>
				<td width="18%" style="font-size: 12px;">{BUYER_FEE}:</td>
				<td align="left" style="font-size: 12px;">{BUYER_FEE_VAL}</td>
			</tr>
			<tr>
				<td width="18%" style="font-size: 12px;">{TAX_TITLE}:</td>
				<td align="left" style="font-size: 12px;">{TAX_FEE}</td>
			</tr>
			<tr>
