<div class="row">
	...
	<?php } ?>
		<div class="col-md-7 well">
			...
			<form name="registration" action="<?php echo (isset($this->_rootref['SSLURL'])) ? $this->_rootref['SSLURL'] : ''; ?>registerlivebid.php" method="post" onsubmit="return validateRecaptcha();">
					     ...
					     <div class="checkbox">
					            ...
					            <input type="checkbox" name="terms_check" id="terms_check"> <?php echo ((isset($this->_rootref['L_858'])) ? $this->_rootref['L_858'] : ((isset($MSG['858'])) ? $MSG['858'] : '{ L_858 }')); ?>
                                             ...
                                             <div class="text-center">
                                                  ...
                                                  <div class="capchabox" style="margin-left: 0!important;"><?php echo (isset($this->_rootref['CAPCHA'])) ? $this->_rootref['CAPCHA'] : ''; ?></div><br/>
...
<script>
    function validateRecaptcha() {
        const response = grecaptcha.getResponse(); // Get reCAPTCHA response token
