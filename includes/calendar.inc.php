...
// Set timezone to the desired USA timezone (e.g., New York)
date_default_timezone_set('America/New_York');

// Get the current date in USA timezone
$current_date = new DateTime('now');

// Convert the current date into a formatted string
$formatted_date = $current_date->format('m-d-Y'); // For USA format (MM-DD-YYYY)

// Generate the calendar months
...
$template->assign_vars(array(
		'CAL_CONF' => $cal_conf,
		'CURRENT_DATE' => $formatted_date, // Pass the USA time formatted date to the template
		));
