...
// echo "Current Time2: " . date("Y-m-d H:i:s") . "<br>";
/***************************************************************************
...
// $formatedtime = date('h:i:s D-M-Y',$NOW);
// print_r($formatedtime);
// die();
function ShowFlags()
{
...
$params = array();
$params[] = array(':start_time', $NOW, 'int');
$params[] = array(':end_time', $NOW, 'int');
