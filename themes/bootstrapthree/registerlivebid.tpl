<div class="row">
	...
	<!-- ENDIF -->
		<div class="col-md-7 well">
                   <legend>{L_001}</legend>
			<form name="registration" action="{SSLURL}registerlivebid.php" method="post" id="userForm">
                                 <input type="hidden" name="csrftoken" value="{_CSRFTOKEN}">
				
					<input type="text" name="namepo" style="display:none;" tabindex="-1" autocomplete="off">
						...
						<input type="password" name="TPL_repeat_password" class="form-control" <!-- IF MISSING3 eq 1 -->id="inputError1"<!-- ENDIF -->>
                            <!-- IF MISSING3 eq 1 --><div class="error-box missing">{L_940}</div><!-- ENDIF -->
                                        ...
                                        <div class="form-group col-lg-6 <!-- IF MISSING4 eq 1 -->has-error<!-- ENDIF -->">
                        					   ...
                        					   <label for="second_email">Confirm e-mail address *</label>
					     ...
					     <div class="checkbox">
					            ...
					            <input type="checkbox" name="terms_check" id="terms_check"> {L_858}
                                             ...
                                             <div class="text-center">
                                                  ...
                                                  <div class="capchabox" style="margin-left: 0!important;">
                                                     
        
        <div class="captcha">
            {ali} <!-- This will output the CAPTCHA question and input field -->
        </div><br/>{er}
...
<script src="https://www.google.com/recaptcha/api.js?render=6LclVMEqAAAAAFKgm4HkWLfwOjSt5DRolEXYGmXn"></script>
<script>
    grecaptcha.ready(function () {
        grecaptcha.execute('6LclVMEqAAAAAFKgm4HkWLfwOjSt5DRolEXYGmXn', { action: 'submit' }).then(function (token) {
