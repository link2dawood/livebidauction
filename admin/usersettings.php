...
if (isset($_POST['action']) && $_POST['action'] == 'update')
{
	...
	$system->writesetting("registration_enabled", $_POST['registration_enabled'], 'bool');
...
loadblock($MSG['25_0151_R'], $MSG['25_0152_R'], 'bool', 'registration_enabled', $system->SETTINGS['registration_enabled'], array($MSG['2__0066'], $MSG['2__0067']));
