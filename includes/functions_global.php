...
class global_class
{
	...
	{
	   // print_r($this->SETTINGS['timezone']);
	   // die();
		global $DBPrefix, $db;
...
// 		print_r($this->SETTINGS['timezone']);
		...
		$this->ctime = $this->getUserTimestamp(time(), $this->SETTINGS['timezone'])+ (8 * 3600);
		// check install directory
//         echo '$this->time is this = ';
//         $this->ctime1 = $this->getUserTimestamp(time(), $this->SETTINGS['timezone']) + $this->tdiff;
//          echo '<br> without Difference <br>';
//         print_r(date('m-d-Y H:i:s',$this->ctime));
//         echo '<br> With Difference <br>';
//         print_r(date('m-d-Y H:i:s',$this->ctime1));
// 		echo '<br> Only Difference';
// 		print_r($this->tdiff);
// 		echo '<br>';
// 		echo'The RAW time = ';
// 		print_r(time());
