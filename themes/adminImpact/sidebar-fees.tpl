			...
			<div class="dropdown grid-margin-btm-md">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                    ...
                    <li class="hide"><a href="{SITEURL}admin/accounts.php">{L_854}</a></li>
                    <li class="hide"><a href="{SITEURL}admin/invoice_settings.php">{L_1094}</a></li>
                    <li class="hide"><a href="{SITEURL}admin/invoice.php">{L_766}</a></li>
				...
				<ul class="list-group hidden-xs">
					...
					<li class="list-group-item hide"><a href="{SITEURL}admin/accounts.php">{L_854}</a></li>
					<li class="list-group-item hide"><a href="{SITEURL}admin/invoice_settings.php">{L_1094}</a></li>
					<li class="list-group-item hide"><a href="{SITEURL}admin/invoice.php">{L_766}</a></li>
