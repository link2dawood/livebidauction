		<div class="row">
			...
			<div class="col-md-9">
				<ol class="breadcrumb"><i class="fa fa-cogs"></i>  <li>{L_25_0009}</li><li><!-- IF B_EDIT_FILE --><!-- IF FILENAME ne '' -->{L_298}: {FILENAME}<!-- ELSE -->{L_518}<!-- ENDIF --><!-- ELSE -->{L_26_0002}<!-- ENDIF --></li></ol>
<!-- IF B_EDIT_FILE -->
							...
							<div class="row md-padding-top">
								...
								<div class="col-md-2">
									<div class="btn-group" role="group" aria-label="...">
										<a class="btn btn-warning btn-xs" href="theme.php?do=listfiles&theme={themes.NAME}" title="{L_26_0003}"><i class="fa fa-edit"></i></a>
									
										<a class="btn btn-success btn-xs" href="theme.php?do=addfile&theme={themes.NAME}" title="{L_26_0004}"><i class="fa fa-plus"></i></a>
									</div>
								</div>
							</div>
...
<!-- BEGIN admin_themes -->
							<div class="row md-padding-top">
								...
								<div class="col-md-2">
									<div class="btn-group" role="group" aria-label="...">
										<a class="btn btn-warning btn-xs" href="theme.php?do=listfiles&theme={admin_themes.NAME}" title="{L_26_0003}"><i class="fa fa-edit"></i></a>
									
										<a class="btn btn-success btn-xs" href="theme.php?do=addfile&theme={admin_themes.NAME}" title="{L_26_0004}"><i class="fa fa-plus"></i></a>
									</div>
								</div>
							</div>
