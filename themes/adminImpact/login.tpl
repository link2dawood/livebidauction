...
<body class="body-login" id="{CURRENT_PAGE}">
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
			    <div class="panel panel-default login-panel">
        <div class="panel-heading text-center">
                        <img src="{SITEURL}themes/{THEME}/img/adminlogo.png" alt="Admin Logo">
                    </div>
			        <div class="panel-body">
<!-- IF PAGE eq 1 -->
				<div class="alert alert-info" role="alert"><i class="fa fa-info-circle"></i>   {L_441}</div>
<!-- ELSE -->
				<div class="alert alert-success" role="alert"><i class="fa fa-info-circle"></i> {L_442}</div>
<!-- ENDIF -->
<!-- IF ERROR ne '' -->
...
<!-- ELSE -->
					<div class="text-center">
						...
						<button class="btn btn-lg btn-success btn-block" type="submit" name="submit">{L_052}</button>
					</div>
<!-- ENDIF -->
				</form>
				    </div>
