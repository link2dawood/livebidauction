        	...
        	<input type="hidden" name="csrftoken" value="{_CSRFTOKEN}">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
                                               ...
                                               <div class="col-sm-3">
						<input maxlength="12" name="minprice" class="form-control" placeholder="{L_1004}"> 
                                               </div>
                                               <div class="col-sm-2">{CURRENCY}</div>
                                               <div class="col-sm-3">
                                               <input maxlength="12" name="maxprice" class="form-control" placeholder="{L_1005}"> 
                                               </div><div class="col-sm-2">{CURRENCY}</div>
					</div>
				</div>
				<div class="form-group">
