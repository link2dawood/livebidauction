         ...
         <div class="panel-heading">
           ...
           <div class="panel-body">
                  ...
                  <div class="well well-sm">
                    ...
                    <small>{L_189}:</small> {to_pay.SHIPPING} x 1 = {to_pay.SHIPPING} / <small>{L_350_1009}</small> {to_pay.ADDITIONAL_SHIPPING} x {to_pay.ADDITIONAL_SHIPPING_QUANTITYS} = {to_pay.ADDITIONAL_SHIPPING_COST}</div>
                  </div>
                   </div>                  
