...
<!-- IF PAGE eq 0 -->
	...
	<!-- IF B_GALLERY -->
					<legend>{L_663}</legend>
						...
						<a target="_blank" href="upldgallery.php" alt="gallery" class="btn btn-primary new-window">{L_677}</a>
	...
	<!-- IF B_FEES -->
                        	...
                        	<div class="alert alert-info" role="alert">
                                       <b>{L_263}: </b><span class="text-danger" id="to_pay"> {FEE_VALUE_F} </span><small> {CURRENCY}</small>
                                </div> 
					</div>
	<!-- ENDIF -->
...
<!-- ELSEIF PAGE eq 2 -->
	...
	<!-- IF B_LIVESTREAM -->
			<tr>
				<td width="40%" align="right"  valign="top"><b>Live Stream Link</b></td>
				<td width="60%" >{SUBTITLE}</td>
			</tr>
	<!-- ENDIF -->
			<tr>
	...
	<!-- ENDIF -->
			...
			<tr>
				<td align="right" valign="top"><b>Live Stream Link</b></td>
				<td>{LIVESTREAM_LINK}</td>
			</tr>
			<tr>
