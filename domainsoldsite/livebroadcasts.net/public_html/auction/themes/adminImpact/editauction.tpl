		<div class="row">
			...
			<div class="col-md-9">
				<ol class="breadcrumb"><i class="fa fa-cogs"></i>  <li>{L_239}</li><li>{L_512}</li></ol>
				<form name="editauction" action="" method="post">
					...
					<tr>
						<td align="right">Live Stream Link</td>
						<td>{LIVESTREAM_LINK} --- <a href="edit_livestream.php?id={ID}">Edit Link</a></td>
					</tr>
					<tr>
						<td align="right">{L_017}</td>
						<td><input type="text" class="form-control" name="title" size="40" maxlength="255" value="{TITLE}"></td>
					</tr>
					<tr>
						<td align="right">{L_806}</td>
						<td><input type="text" class="form-control name="subtitle" size="40" maxlength="255" value="{SUBTITLE}"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><textarea name="description" class="form-control cols="40" rows="8">{DESC}</textarea></td>
					</tr>
					<tr>
						<td align="right">{L_258}</td>
						<td><input type="text" class="form-control name="quantity" size="40" maxlength="40" value="{QTY}"></td>
					</tr>
					<tr>
...
<!-- BEGIN gallery -->
							<div style="width:90px; float: left;">
								<a href="{SITEURL}/{gallery.V}" title="{gallery.V}" target="_blank">
									<img src="{SITEURL}getthumb.php?fromfile={gallery.V}" width="80px" border="0">
								</a>
...
<!-- END gallery -->
					...
					<tr>
						...
						<td><input type="text" class="form-control name="min_bid" size="40" maxlength="40" value="{MIN_BID}"></td>
					</tr>
					<tr>
						<td align="right">{L_023}</td>
						<td><input type="text" class="form-control name="shipping_cost" size="40" maxlength="40" value="{SHIPPING_COST}"></td>
					</tr>
					<tr>
						<td align="right">{L_021}</td>
						<td><input type="text" class="form-control name="reserve_price" size="40" maxlength="40" value="{RESERVE}"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="form-control name="buy_now" size="40" maxlength="40" value="{BN_PRICE}"></td>
					</tr>
					<tr>
						<td align="right">{L_120}</td>
						<td>
							<input type="text" class="form-control name="customincrement" size="10" value="{CUSTOM_INC}">
						</td>
					</tr>
					<tr>
						<td colspan="2" style="padding:3px; border-top:#0083D7 1px solid; background:#ECECEC;">
					...
					<tr>
						...
						<td><textarea class="form-control name="shipping_terms" rows="3" cols="34">{SHIPPING_TERMS}</textarea></td>
					</tr>
					<tr>
						<td colspan="2" style="padding:3px; border-top:#0083D7 1px solid; background:#ECECEC;">
							<b>{L_5233}</b>
