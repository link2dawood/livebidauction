		<div class="row">
			...
			<div class="col-md-9">
				<ol class="breadcrumb"><i class="fa fa-money"></i>  <li>{L_25_0012}</li><li>{L_842}</li></ol>
<!-- IF B_NOT_SETUP_CORRECTLY -->
				<div class="alert alert-danger" role="alert"><i class="fa fa-warning"></i> {L_1144}</div>
<!-- ENDIF -->
<!-- IF FEETYPE ne '' -->
							...
							<div class="row">
								...
								<div class="col-md-9">
								    <div class="form-group input-group">
                                        ...
                                        <input type="text" class="form-control" size="12" name="value" value="{VALUE}">
                                    </div>
								</div>
							</div>
	<!-- ELSE -->
		...
		<!-- BEGIN fees -->
							<div class="row">
								...
								<div class="col-md-2">
									...
									<input class="form-control" name="fee_from[]" type="text" value="{fees.FROM}" size="9">
								</div>
								<div class="col-md-2"><input class="form-control" name="fee_to[]" type="text" value="{fees.TO}" size="9"></div>
								<div class="col-md-2"><input class="form-control" name="value[]" type="text" value="{fees.VALUE}" size="9"></div>
								<div class="col-md-2">
		...
		<!-- END fees -->
							<div class="row">
								...
								<div class="col-md-2"><input class="form-control" name="new_fee_from" type="text" size="9" value="{FEE_FROM}"></div>
								<div class="col-md-2"><input class="form-control" name="new_fee_to" type="text" size="9" value="{FEE_TO}"></div>
								<div class="col-md-2"><input class="form-control" name="new_value" type="text" size="9" value="{FEE_VALUE}"></div>
								<div class="col-md-2">
