<div class="row">
			...
			<div class="col-md-9">
				<ol class="breadcrumb"><i class="fa fa-cogs"></i>  <li><?php echo (isset($this->_rootref['TYPENAME'])) ? $this->_rootref['TYPENAME'] : ''; ?></li><li><?php echo (isset($this->_rootref['PAGENAME'])) ? $this->_rootref['PAGENAME'] : ''; ?></li></ol>
...
<?php } else { ?>
							<td width="140"><?php echo $_block_val['TITLE']; ?></td>
							<td>
		...
		<?php } else if ($_block_val['TYPE'] == ('text')) {  ?>
									<input type="text" class="form-control" name="<?php echo $_block_val['NAME']; ?>" value="<?php echo $_block_val['DEFAULT']; ?>" size="50" maxlength="255">
		<?php } else if ($_block_val['TYPE'] == ('password')) {  ?>
									<input type="password" class="form-control" name="<?php echo $_block_val['NAME']; ?>" value="<?php echo $_block_val['DEFAULT']; ?>" size="50" maxlength="255">
		<?php } else if ($_block_val['TYPE'] == ('textarea')) {  ?>
									<textarea class="form-control name="<?php echo $_block_val['NAME']; ?>" cols="65" rows="10"><?php echo $_block_val['DEFAULT']; ?></textarea>
		<?php } else if ($_block_val['TYPE'] == ('days')) {  ?>
									<input type="text" class="form-control" name="<?php echo $_block_val['NAME']; ?>" value="<?php echo $_block_val['DEFAULT']; ?>" size="6" maxlength="6"> <?php echo $_block_val['TAGLINE1']; ?>
		<?php } else if ($_block_val['TYPE'] == ('percent')) {  ?>
									<input type="text" class="form-control" name="<?php echo $_block_val['NAME']; ?>" value="<?php echo $_block_val['DEFAULT']; ?>" size="3" maxlength="3"> <?php echo $_block_val['TAGLINE1']; ?>
		<?php } else if ($_block_val['TYPE'] == ('decimals')) {  ?>
									<input type="text" class="form-control" name="<?php echo $_block_val['NAME']; ?>" value="<?php echo $_block_val['DEFAULT']; ?>" size="5" maxlength="10"> <?php echo $_block_val['TAGLINE1']; ?>
