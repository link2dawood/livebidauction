...
if (isset($_POST['action']) && $_POST['action'] == 'update')
{
	...
	else
	{
		...
		$system->writesetting("liveauction_start", $_POST['liveauction_start'], 'str');
...
//loadblock($MSG['5091_a'], $MSG['5091_a'], 'days', 'liveauction_start', $system->SETTINGS['liveauction_start']);
$string1 = $MSG['5091_a'] . ' <input type="datetime-local" id="datepicker" name="liveauction_start" value="' . $system->SETTINGS['liveauction_start'] . '">';
loadblock($MSG['5091_a'], $string1, '');
