		<div class="row">
			...
			<div class="col-md-9">
				<ol class="breadcrumb"><i class="fa fa-cogs"></i>  <li>{TYPENAME}</li><li>{PAGENAME}</li></ol>
...
<!-- ELSE -->
		...
		<!-- ELSEIF block.TYPE eq 'text' -->
									<input type="text" class="form-control" name="{block.NAME}" value="{block.DEFAULT}" size="50" maxlength="255">
		<!-- ELSEIF block.TYPE eq 'password' -->
									<input type="password" class="form-control" name="{block.NAME}" value="{block.DEFAULT}" size="50" maxlength="255">
		<!-- ELSEIF block.TYPE eq 'textarea' -->
									<textarea class="form-control name="{block.NAME}" cols="65" rows="10">{block.DEFAULT}</textarea>
		<!-- ELSEIF block.TYPE eq 'days' -->
									<input type="text" class="form-control" name="{block.NAME}" value="{block.DEFAULT}" size="6" maxlength="6"> {block.TAGLINE1}
		<!-- ELSEIF block.TYPE eq 'percent' -->
									<input type="text" class="form-control" name="{block.NAME}" value="{block.DEFAULT}" size="3" maxlength="3"> {block.TAGLINE1}
		<!-- ELSEIF block.TYPE eq 'decimals' -->
									<input type="text" class="form-control" name="{block.NAME}" value="{block.DEFAULT}" size="5" maxlength="10"> {block.TAGLINE1}
