    	...
    	<form name="" method="post" action="pay.php?a=1" id="fees">
              ...
              <div class="input-group">
                  <span class="input-group-addon">{CURRENCY}</span>
                    <input type="text" name="pfval" value="{USER_BALANCY}" class="form-control">
                     <span class="input-group-btn"><input type="submit" name="{L_1104}" value="Pay Total Balance Here" class="btn btn-primary"></span>
              </div>
              </div>
        </form>
    </div>
