...
switch($_GET['a'])
{
	...
	case 2: // pay for an item
		$query = "SELECT w.id, w.seller, w.tax_fee, a.title, a.shipping_cost, a.additional_shipping_cost, a.shipping, w.bid,w.buyer_fee,
		...
		$payvalue = ($data['bid'] * $data['qty']) + $shipping_cost + $data['buyer_fee'] + $data['tax_fee'];
