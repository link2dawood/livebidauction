...
<!-- ELSE -->
	...
	<!-- ELSEIF block.TYPE eq 'text' -->
								<input type="text" name="{block.NAME}" class="form-control" value="{block.DEFAULT}" size="50" maxlength="255">
	<!-- ELSE -->
								{block.TYPE}
	<!-- ENDIF -->
							</td>
...
<!-- END block -->
						<tr valign="top">
							<td  colspan="2">
								<button type="button" class="btn btn-warning" onclick="showDialog();return false;">{L_1137}</button>
							</td>
						</tr>
					</table>
				</div>
